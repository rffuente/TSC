var boletasView = {
    ...
    buildUserData: function(data){
        $('#contribuyente-name').val(data.nombres);
        $('#contribuyente-lastnames').val(data.apellidos);
        $('#contribuyente-address').val(data.direccion);
        $('#contribuyente-rut').val(data.rut);
    }
}
